...
all: build/proceeding.pdf build/plot2.pdf
...
build/plot2.pdf:matplotlibrc_pgf matplotlib_header.tex settings.tex plot2.py | build
	MATPLOTLIBRC=matplotlibrc_pgf TEXINPUTS=$(shell pwd): python plot2.py
